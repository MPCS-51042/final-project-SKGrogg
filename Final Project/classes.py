...
class Running (Exercise):
    ...
    def find_plan(self):
        ...
        if self.distance == "mile":
            ...
            return "CYou can find a training program courtesy of Runners' World at the link below. Please be warned: An ultra-marathon is not recommended for inexperiences runners. Proceed with caution",\
    ...
    def find_events(self, athlete):
        ...
        url = f"https://www.active.com/search?keywords={self.distance}&include_virtual_events=1&location={athlete.zipcode}&category=Activities&daterange=All+future+dates"
...
class Swimming(Exercise):
    ...
    #Find local lap pools #MIGHT BE A SMALL GLITCH??? WHEN I LOOKED FOR BOSTON POOLS, BRINGS TO TEXAS. ALL OTHER ZIPS WORk?
...
class Cycling(Exercise):
    ...
    def find_plan(self):
        ...
        elif self.distance == "60km":
            return "You can find a training program courtesy of 'Cycling Weekly' at the link below.",\
                 "https://issuu.com/futurepublishing/docs/cyw_aruk_trainingplan?fr=sYTUxOTMxMDYwNDY"
...
#     #racefinder NEED TO WORK ON THIS
#     def find_events():
#         pass
...
class Triathlon(Exercise): 
    ...
    def find_events(self, athlete):
            ...
            return f"https://www.active.com/search?keywords={self.distance}+triathlon&include_virtual_events=1&location={athlete.zipcode}&category=Activities&daterange=All+future+dates"
...
class Weight_Lifting(Exercise):
    ...
    #Sets the kind of lifting and equipment budget
    ...
    def find_plan(self):
        if self.weight == "bodyweight":
            ...
            return "Here is a 3-Days-A-Week high-weight, low-rep plan, courtsy of aworkoutroutine.com", "https://www.aworkoutroutine.com/the-muscle-building-workout-routine/"
    ...
    def find_equipment(self):
        if self.budget == "100":
            ...
            return "Here are some options to mix-and-match from.",\
            ...
            return "Here are some options to mix-and-match from.",\
                ("Dip Bar","https://www.amazon.com/Dripex-Adjustable-Connectors-Equipment-Calisthenics/dp/B08YYV47VJ/ref=asc_df_B08YYV47VJ/?tag=hyprod-20&linkCode=df0&hvadid=519485156281&hvpos=&hvnetw=g&hvrand=8903438363440240713&hvpone=&hvptwo=&hvqmt=&hvdev=c&hvdvcmdl=&hvlocint=&hvlocphy=9067609&hvtargid=pla-1366979420617&psc=1"),\
                     ("Pull-Up Bar", "https://www.amazon.com/Pure-Fitness-Multi-Purpose-Doorway-Pull-Up/dp/B00EB3HFHS/ref=asc_df_B00EB3HFHS/?tag=hyprod-20&linkCode=df0&hvadid=198074695887&hvpos=&hvnetw=g&hvrand=8318379034813128993&hvpone=&hvptwo=&hvqmt=&hvdev=c&hvdvcmdl=&hvlocint=&hvlocphy=9067609&hvtargid=pla-322054613682&psc=1"),\
                         ("Resistance Bands", "https://www.walmart.com/ip/Portable-Home-Gym-Pilates-Bar-System-Full-Body-Workout-Equipment-Training-Kit/292607978?wmlspartner=wlpa&selectedSellerId=16214&&adid=22222222227351084064&wl0=&wl1=g&wl2=c&wl3=440999815848&wl4=pla-913994989822&wl5=9067609&wl6=&wl7=&wl8=&wl9=pla&wl10=120798572&wl11=online&wl12=292607978&veh=sem&gclid=EAIaIQobChMI4NqYnYuv9AIVi77ICh3npQTcEAQYEiABEgJdOfD_BwE&gclsrc=aw.ds"),\
                             ("Adjustable Free-Weights", "https://www.bowflex.com/selecttech/552/100131.html?adID=DOFG2BFEED1&pk_source=google&pk_medium=cpc&gclid=EAIaIQobChMI4NqYnYuv9AIVi77ICh3npQTcEAQYBSABEgKulvD_BwE"),\
                                 ("Spin Bike", "https://www.google.com/search?q=spin+bikes+under+300&rlz=1C5CHFA_enUS837US837&ei=7TGdYYHKG6iVwbkP3fORoAo&ved=0ahUKEwjB9NXYja_0AhWoSjABHd15BKQQ4dUDCA4&uact=5&oq=spin+bikes+under+300&gs_lcp=Cgdnd3Mtd2l6EAMyBQgAEIAEMgYIABAWEB46BwgAEEcQsAM6BwgAELADEEM6CgguEMgDELADEEM6EAguEMcBENEDEMgDELADEEM6BwgAEMkDEEM6BAgAEEM6CAgAEIAEEMkDOgUIABCRAkoFCDgSATFKBAhBGABQ2gJYmRNggRVoAXACeACAAWCIAbEGkgECMTCYAQCgAQHIAQvAAQE&sclient=gws-wiz"),\
...
class Yoga(Exercise):
    ...
    #Handled exclusively through main app
    def find_equipment(self, athlete):
        pass
